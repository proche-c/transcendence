    ...
    render() {
        ...
        this.shadowRoot.innerHTML = `
			<nav class="flex p-2 rounded-lg shadow-lg m-2 justify-between">
				<div>
					<a id="profile" href="#profile" class="ml-0 ${isActive("#profile")} hover:text-purple-950 font-bold mx-1 my-1 lg:text-3xl lg:mx-10 lg:ml-0">PROFILE</a>
					<a id="board" href="#board" class="${isActive("#board")} hover:text-purple-950 font-bold mx-1 my-1 lg:text-3xl lg:mx-10 lg:ml-0">LEADER BOARD</a>
					<a id="play" href="#play" class="${isActive("#play")} hover:text-purple-950 font-bold mx-1 my-1 lg:text-3xl lg:mx-10 lg:ml-0">PLAY</a>
				</div>
