class MenuComponent extends HTMLElement {
	...
	private render(): void {
		...
		<div class="flex h-screen items-center">
			<div class="flex h-7/8 w-10 md:w-32 flex-col items-center justify-around border-e border-violet-700 bg-white rounded-4xl my-10 px-2 ml-4">	
				<div>
					...
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 md:size-16">
				...
				<div class="border-t border-gray-100 bg-white p-2">
    				<a href="#" class="group relative flex w-full justify-center rounded-lg py-1.5 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-700">
      				<svg xmlns="http://www.w3.org/2000/svg" class="size-6 md:size-16 opacity-75" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
	...
	private addEventListeners(): void {
		...
		const friendsLink = this.shadowRoot?.querySelector("#friends");
