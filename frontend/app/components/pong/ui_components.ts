...
export function renderLocalGame(ctx: CanvasRenderingContext2D, gameState: GameState) {
    ctx.fillStyle = '#fff';
...
export function renderCrazyGame(ctx: CanvasRenderingContext2D, gameState: CrazyGameState) {
    const boardSize = 800;
...
export function showWinnerMessage(ctx: CanvasRenderingContext2D, canvas: HTMLCanvasElement, message: string) {
...
export function startCountdown(
    ...
    gameState: GameState | CrazyGameState,
    onComplete: () => void
) {
    let count = 3;
