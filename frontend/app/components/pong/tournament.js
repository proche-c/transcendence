...
export function setupTournament(shadowRoot) {
    if (!shadowRoot)
        return null;
...
export function renderTournamentSetup(shadowRoot) {
    // Afegir el CSS
...
function setupTournamentFormListeners(shadowRoot) {
    const form = shadowRoot.getElementById('tournamentForm');
    ...
    form === null || form === void 0 ? void 0 : form.addEventListener('submit', (e) => {
        e.preventDefault();
        const tournamentNameInput = shadowRoot.getElementById('tournamentName');
        ...
        const playerInputs = (playersList === null || playersList === void 0 ? void 0 : playersList.querySelectorAll('input')) || [];
        const players = [];
    ...
    // Back to menu button
    backToMenuBtn === null || backToMenuBtn === void 0 ? void 0 : backToMenuBtn.addEventListener('click', () => {
        // This will trigger the rendering of PlayComponent's menu
        const playComponent = shadowRoot.host;
        if (playComponent.tagName.toLowerCase() === 'pong-play') {
            const playComponentInstance = playComponent;
...
function loadSavedTournaments(shadowRoot) {
...
function renderTournamentBracket(shadowRoot, tournament) {
    const style = document.createElement("link");
    style.rel = "stylesheet";
    style.href = "./app/tailwind.css";
    shadowRoot.innerHTML = `
...
function generateBracketVisual(shadowRoot, tournament) {
    var _a, _b;
    ...
    bracketContainer.innerHTML = `
        <div class="flex flex-col items-center">
            ...
            <div class="w-1/2 bg-gray-100 p-3 rounded-lg border border-gray-300">
                ...
                <div class="flex justify-between items-center mt-2">
                    <span id="final-player1" class="font-medium">${((_a = tournament.matches[2]) === null || _a === void 0 ? void 0 : _a.player1) || "TBD"}</span>
                    <span class="mx-2">vs</span>
                    <span id="final-player2" class="font-medium">${((_b = tournament.matches[2]) === null || _b === void 0 ? void 0 : _b.player2) || "TBD"}</span>
...
function setupNextMatch(shadowRoot, tournament) {
...
function startTournamentMatch(shadowRoot, tournament, match) {
...
function setupTournamentGame(shadowRoot, tournament, match) {
    if (!shadowRoot)
        return;
    ...
    function endTournamentMatch(winner) {
...
function renderTournamentGame(ctx, gameState, match) {
    // Clear canvas
...
function updateTournamentProgress(tournament) {
