...
export function createInitialCrazyGameState(): CrazyGameState {
    const boardSize = 800;
...
export function resetBall(gameState: GameState, flag: number) {
...
export function handlePlayerMovement(gameState: GameState, keys: Record<string, boolean>) {
...
export function checkPaddleCollisions(gameState: GameState) {
...
export async function reportResultToServer(gameState: GameState) {
